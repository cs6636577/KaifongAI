    ...
    return (
        <div className={`h-16 bg-secondary flex items-center justify-between px-6 shadow-md transition-all duration-300 ${
            ...
            <div className="flex flex-row items-center gap-4">
                ...
                <input
                    type="text"
                    className="w-xs text-[#333847] rounded-full border border-white/20 bg-[#EAEDFF] py-2.5 pl-12 pr-4 text-sm text-gray placeholder:text-[#333847] outline-none focus:border-white/30 focus:ring-2 focus:ring-white/10"
