            ...
            <main className="flex w-full flex-col justify-center items-center">
              ...
              <form className="w-full max-w-sm mx-auto">
                <div className="mb-5 relative flex items-center">
                  ...
                  <input className="w-full pl-12 pr-4 py-3 border-1 border-black rounded-2xl text-gray-700 placeholder-gray-500 focus:outline-none focus:border-primary" id="username" type="text" placeholder="อีเมล / หมายเลขโทรศัพท์"/>
                </div>
                <div className="mb-8 relative flex items-center">
                  ...
                  <input className="w-full pl-12 pr-4 py-3 border-1 border-black rounded-2xl text-gray-700 placeholder-gray-500 focus:outline-none focus:border-primary" id="password" type="password" placeholder="รหัสผ่าน"/>
                </div>
